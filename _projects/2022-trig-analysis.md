...
Lab Setup
![Lab Setup]({{ '/assets/images/IMG_6926.JPG' | relative_url }}){: width="100" }

During Lab Activity
![During Activity]({{ "/assets/images/IMG_6925.JPG" | relative_url }}){: width="100" }
...
![Counter Flow Diagram]({{ "/assets/images/IMG_0152.jpg" | relative_url }}){: width="200" }

Parallel Flow Diagram
![Parallel Flow Diagram]({{ "/assets/images/IMG_0153.jpg" | relative_url }}){: width="200" }
